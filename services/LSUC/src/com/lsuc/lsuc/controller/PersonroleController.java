...
public class PersonroleController {
    ...
    public Personrole getByPersonFkAndRoleFk(@RequestParam("personFk") int personFk, @RequestParam("roleFk") Integer roleFk) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getPersonroleAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return personroleService.getAggregatedValues(aggregationInfo, pageable);
    }
