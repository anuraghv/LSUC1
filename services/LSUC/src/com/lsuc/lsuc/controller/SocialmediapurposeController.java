...
public class SocialmediapurposeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getSocialmediapurposeAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return socialmediapurposeService.getAggregatedValues(aggregationInfo, pageable);
    }
