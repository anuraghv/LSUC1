Application.$controller("RecentActivityPageController", ["$scope", function($scope) {
    ...
    $scope.getAllStatusonSuccess = function(variable, data) {
        if (data.length == 0) {
            return;
        }
    ...
    $scope.PersonAuditonSuccess = function(variable, data) {
        if (data.length == 0) {
            return;
        }
    ...
    $scope.PersonaddressAuditonSuccess = function(variable, data) {
        if (data.length == 0) {
            return;
        }
